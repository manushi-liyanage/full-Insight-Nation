...
//           <Link
//             to="/"
//             className="inline-block mt-4 text-sm text-blue-600 border border-blue-600 px-4 py-2 rounded hover:bg-blue-600 hover:text-white transition duration-200"
//           >
//             ⬅ Back to Cover Page
//           </Link>
//         </div>
        ...
        <div className="bg-white/10 backdrop-blur-md shadow-xl rounded-2xl p-8 border border-white/20 animate-fadeIn">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <div>
                <Link to="/forgot-password" className="font-medium text-blue-300 hover:text-white transition duration-300">
                  Forgot password?
                </Link>
              </div>
            </div>
          ...
          <div className="mt-8 pt-6 text-center border-t border-white/10">
            <p className="text-gray-200">Don't have an account?{" "}
              <Link to="/signup" className="font-medium text-blue-300 hover:text-white transition duration-300">
                Sign up
              </Link>
            </p>
          </div>
